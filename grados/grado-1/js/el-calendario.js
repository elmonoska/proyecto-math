...
function diasYMes() {
  ...
  queDiaEsHoy.addEventListener("change", (e) => {
    ...
    if (diaSeleccionado === diaActualLetra) {
      queDiaEsHoy.classList =
        "border border-success bg-success bg-opacity-25 form-select mb-3 text-center";
    } else {
      queDiaEsHoy.classList =
        "border border-danger bg-danger bg-opacity-25 form-select mb-3 text-center";
    }
  });
