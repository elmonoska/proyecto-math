...
function resta5Ejercicios1() {
  ...
  for (let i = 0; i < 5; i++) {
    ...
    resta5Ejercicios1.appendChild(
      li
    ).innerHTML = `Resta ${numero1} <span class="text-math-danger buble-gum fs-3 align-middle"> - </span> ${numero2}`;
  }
}
