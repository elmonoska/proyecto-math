...
//Funcion que genera 5 ejemplos aleatorios en la tabla antecesor-sucesor-3-ejemplos
...
btnConsultaNumeros.addEventListener('click', (e) => {
    ...
    const msgErrorTableMayorMenorIgualQue = document.querySelector('#msgErrorTableMayorMenorIgualQue')
    e.preventDefault();
    if (isNaN(inputNumeroIntroducido.value) || inputNumeroIntroducido.value === "") {
        msgErrorTableMayorMenorIgualQue.textContent = 'Debes introducir solamente numeros.'
        ...
        tbodyTableGenerarAntYSuc.children[0].children[0].textContent = parseInt(inputNumeroIntroducido.value) - 1
        tbodyTableGenerarAntYSuc.children[0].children[1].children[0].textContent = parseInt(inputNumeroIntroducido.value)
        tbodyTableGenerarAntYSuc.children[0].children[2].textContent = parseInt(inputNumeroIntroducido.value) + 1
